...
@NgModule({
  imports:      [ BrowserModule, FormsModule,BsDropdownModule.forRoot(), AngularFontAwesomeModule ],
  declarations: [ AppComponent, MySelectorComponent, Client1Component, Client2Component ],
